# Cal Coast Hardscape & Irrigation — Website Source Code

This is the complete, editable source code for the Cal Coast Hardscape &
Irrigation website. It is a standard **React + Vite** project with
**Tailwind CSS**. Any web developer can run, edit, and deploy it. There are
...
## Forms
The booking and contact forms submit via **Netlify Forms** (built into
Netlify hosting, no external service required). If you host elsewhere, you
will need to wire up an alternate form handler.
