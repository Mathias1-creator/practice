# SLO Septic Pumping LLC — Website Source Code

This is the complete, editable source code for the SLO Septic Pumping LLC
...
## Notes
- All images are local to this project; nothing loads from an external
  account. Two service photos are licensed Unsplash stock images (free
  for commercial use).
- `node_modules` and `dist` are not included on purpose — they are
  regenerated by the commands above. This keeps the download small.
