...
const CTA_IMAGE = 'https://media.base44.com/images/public/6a25de119f5f78bb1df59f6d/757f60907_generated_image.png';

export default function RealtorsCta() {
  return (
    <section className="relative min-h-[480px] md:min-h-[520px] flex items-center overflow-hidden">
      <img
        src={CTA_IMAGE}
        alt="Stunning Sonoma estate property at golden hour (placeholder)"
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-5 md:px-8 py-16 md:py-24 w-full text-center">
        <RevealWrapper>
          ...
          >
            Let's get your listing sold
          </h2>
          <p
            className="font-body text-[16px] md:text-[18px] leading-relaxed max-w-[520px] mx-auto mb-10"
            style={{ color: 'rgba(255,255,255,0.88)' }}
          >
            Reach out to talk through a property, a timeline, or an ongoing partnership.
          </p>
