...
const HERO_IMAGE = 'https://media.base44.com/images/public/6a25de119f5f78bb1df59f6d/2b60bf57d_generated_image.png';
...
export default function ContactHero() {
  ...
  return (
    <section className="relative overflow-hidden" style={{ height: '50vh', minHeight: '420px' }}>
      <img
        src={HERO_IMAGE}
        alt="Serene Sonoma County landscape at golden hour (placeholder)"
      ...
      <div className="relative z-10 h-full flex items-center justify-center text-center px-5 md:px-8">
        <div className="max-w-[820px] mx-auto">
          ...
          >
            Tell us about your property and what you need, and we will get back to you to set up a free quote.
          </p>
        </div>
      </div>
    </section>
