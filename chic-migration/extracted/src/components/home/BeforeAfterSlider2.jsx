...
const beforeImg = '/images/f1c5ffd1c_gc_before_2.jpg';
const afterImg = '/images/48ccb1066_gc_after_2.jpg';
    ...
    <section className="py-20 md:py-28" style={{ background: '#f2ece6' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="font-heading text-3xl md:text-5xl font-semibold" style={{ color: '#1e1e1e' }}>
